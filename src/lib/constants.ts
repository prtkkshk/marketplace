...
export const CATEGORIES = [
  { id: 'cycles', label: 'Cycles & Accessories', icon: '🚲' },
  { id: 'books', label: 'Books, Notes & Academics', icon: '📚' },
  { id: 'electronics', label: 'Electronics & Gadgets', icon: '💻' },
  { id: 'room_essentials', label: 'Room Essentials & Furniture', icon: '🛏️' },
  { id: 'lab_gear', label: 'Lab & Course Gear', icon: '🥼' },
