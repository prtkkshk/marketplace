  ...
  return (
    <PageContainer className="p-4 max-w-2xl mx-auto text-left py-6 pb-24">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-display italic font-bold text-ink">Campus Trading Rules & Policy</h1>
          <p className="text-xs text-ink-3">IIT Kharagpur second-hand marketplace guidelines (§11)</p>
        </div>
      </div>
      ...
      <Card className="mb-4 bg-brand-wash/40 border-brand-light">
        <h2 className="text-base font-bold text-brand mb-2 flex items-center gap-2">
        ...
        <div className="p-3 bg-white rounded-xl border border-line text-xs text-ink font-medium">
