...
export const RulesScreen: React.FC = () => {
 return (
 <PageContainer className="p-4 max-w-2xl mx-auto text-left py-6 pb-24">
 <div className="flex items-center gap-3 mb-6">
 <ShieldAlert className="w-8 h-8 text-accent" />
 <div>
 <h1 className="text-3xl font-display font-bold text-ink">Campus Trading Rules & Policy</h1>
 <p className="text-xs text-subtle">IIT Kharagpur second-hand marketplace guidelines (§11)</p>
 </div>
 </div>

 {/* Prohibited Items */}
 <Card className="mb-4">
 <h2 className="text-base font-bold text-ink mb-3 text-danger flex items-center gap-2">
 <span>Prohibited Items (Zero Tolerance)</span>
 </h2>
 <ul className="list-disc list-inside text-xs text-ink flex flex-col gap-2 leading-relaxed">
 <li>
 ...
 <div className="flex flex-col gap-2 text-xs text-subtle leading-relaxed">
 <p>
 ...
 <Card className="mb-4 bg-accent-wash/40 border-accent">
 ...
 <div className="p-3 bg-surface rounded-xl border border-line text-xs text-ink font-medium">
