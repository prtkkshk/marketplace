...
import { ShoppingBag, Megaphone, Shield, Edit3, FileText, Settings } from 'lucide-react';
...
export const ProfileScreen: React.FC = () => {
 ...
 {/* Hero */}
 <div className="bg-surface rounded-2xl p-6 mb-6 text-center border border-line shadow-hard relative overflow-hidden">
 <div className="mx-auto w-16 h-16 bg-bg border-2 border-accent rounded-2xl flex items-center justify-center text-ink font-display text-3xl mb-3 shadow-hard">
 ...
 <p className="text-sm text-subtle mb-4">{profile?.email}</p>
 ...
 {isAdmin && <span className="text-xs font-semibold px-2 py-1 rounded-md bg-accent-wash border border-ink text-accent">Admin</span>}
 </div>
 ...
 <Link to="/rules" className="flex items-center gap-3 p-4 hover:bg-bg transition-colors border-b border-line">
 <div className="w-8 h-8 rounded bg-accent-wash text-accent flex items-center justify-center shrink-0">
 <FileText className="w-4 h-4" />
 </div>
 <div className="flex-1">
 <div className="text-sm font-semibold text-ink">Campus Trading Rules</div>
 <div className="text-xs text-subtle">Policies and guidelines</div>
 </div>
 </Link>
 ...
 className="w-full flex items-center gap-3 p-4 hover:bg-bg transition-colors"
 >
 <div className="w-8 h-8 rounded bg-surface-2 text-ink flex items-center justify-center shrink-0">
 <Edit3 className="w-4 h-4" />
 </div>
 <div className="flex-1 text-left">
 <div className="text-sm font-semibold text-ink">Edit Profile</div>
 <div className="text-xs text-subtle">Update your details</div>
 </div>
 </button>
 </div>

 {isAdmin && (
 <div className="bg-surface border border-ink rounded-xl overflow-hidden">
 <Link to="/admin" className="flex items-center justify-between p-4 hover:bg-accent-wash transition-colors">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded bg-accent text-bg flex items-center justify-center shrink-0">
 <Shield className="w-4 h-4" />
 </div>
 <div>
 <div className="text-sm font-semibold text-accent">Admin Panel</div>
 <div className="text-xs text-accent/80">Manage platform</div>
 </div>
 </div>
 </Link>
 </div>
 ...
 <Button
 variant="secondary"
 className="w-full text-subtle justify-center"
 onClick={() => signOut()}
 ...
 <Button variant="secondary" className="flex-1" onClick={() => setIsDeleting(false)}>
 Cancel
 </Button>
 <Button variant="secondary" className="flex-1" loading={loading} onClick={handleDeleteAccount}>
 Permanently Delete
 </Button>
 </div>
 </div>
