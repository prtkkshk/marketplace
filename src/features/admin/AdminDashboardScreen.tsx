...
export const AdminDashboardScreen: React.FC = () => {
  ...
  const maxHallCount = Math.max(...stats.hallDistribution.map((h) => h.count), 1);
    ...
    <div className="flex flex-col gap-6 text-left">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <Card className="p-4 flex flex-col justify-between">
          ...
          <span className="text-2xl font-black text-content-primary">{stats.activeListings}</span>
        ...
        <Card className="p-4 flex flex-col justify-between">
          ...
          <span className="text-2xl font-black text-content-primary">{stats.soldListings}</span>
        ...
        <Card className="p-4 flex flex-col justify-between">
          ...
          <span className="text-2xl font-black text-content-primary">{stats.openRequests}</span>
        ...
        <Card className="p-4 flex flex-col justify-between border-rose-200 bg-rose-50/40">
          ...
          <span className="text-2xl font-black text-status-danger">{stats.pendingReports}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <div className="flex flex-col gap-3">
            {stats.hallDistribution.slice(0, 6).map((hall) => (
      ...
      <Card>
        ...
        <div className="flex flex-col gap-2 divide-y divide-surface-border">
          {stats.recentActivity.map((act) => (
            <div key={act.id} className="pt-2 flex items-center justify-between text-xs text-content-primary">
              <span>{act.title}</span>
